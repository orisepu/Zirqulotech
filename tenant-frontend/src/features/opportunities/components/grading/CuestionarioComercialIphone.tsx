...
import { CuestionarioComercialInput, DisplayImageStatus, GlassStatus, GradingParamsPorModelo, HousingStatus } from '@/shared/types/grading'
import { calcularOferta } from '@/shared/utils/gradingCalcs'
